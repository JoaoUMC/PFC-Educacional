// src/app/educacional/o-que-sao-criptomoedas/page.tsx
      ...
      <article className="mx-auto max-w-5xl">
        ...
        <div className="mt-6 space-y-6 text-base md:text-lg leading-relaxed text-neutral-300">
          <p>
            ...
            uma autoridade central. Em vez de contas num banco, cada participante
            possui uma chave privada que assina transações e uma chave pública
            que gera um endereço para receber valores. As propriedades mais
            marcantes desse arranjo são a descentralização, a imutabilidade dos
            registros após confirmados, a transparência do histórico e a
            possibilidade de programar escassez e regras de funcionamento
            diretamente no protocolo. Isso torna possível operar um sistema de
            transferências globais e sempre aberto, no qual taxas e inclusão de
            transações são coordenadas por mecanismos de consenso (como Prova de
            Trabalho ou Prova de Participação) e por incentivos econômicos. Na
            prática, criptomoedas servem como meio de troca e, em alguns casos,
            como reserva de valor, mas também como base para plataformas
            programáveis que hospedam contratos inteligentes, aplicativos
            financeiros descentralizados, jogos, identidades digitais e processos
          ...
          <p>
            ...
            contratos inteligentes, permitindo que a própria lógica de aplicações
            financeiras, mercados, jogos e organizações fosse codificada e
            executada on-chain. Entre 2017 e 2020, consolidaram-se padrões
            técnicos (como ERC-20 e ERC-721), expandiram-se as finanças
            descentralizadas (DeFi) e popularizaram-se stablecoins, que reduziram
            a volatilidade para muitos usos práticos. De 2020 em diante,
            ganharam tração as soluções de escalabilidade em camadas (layer 2,
            especialmente rollups), o staking em redes de Prova de Participação e
            novas abordagens de usabilidade e segurança, como abstração de contas
            e mecanismos mais sofisticados de governança e tokenização.
          </p>
          ...
          <p>
            ...
            precificação e crédito em DeFi; e há ainda tokens com características
            de valor mobiliário (security tokens), que podem representar
            participação societária, dívida ou fluxos de caixa e, por isso,
            costumam envolver exigências regulatórias específicas conforme a
            jurisdição. Em conjunto, moedas nativas e tokens estendem a noção
            original de “moeda digital” para um espectro mais amplo de
